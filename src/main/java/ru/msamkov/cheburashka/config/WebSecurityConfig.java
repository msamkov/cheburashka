package ru.msamkov.cheburashka.config;
...
import ru.msamkov.cheburashka.filter.JWTAuthenticationFilter;
import ru.msamkov.cheburashka.filter.JWTLoginFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    System.out.println("Encoded password of tompassword=" + encrytedPassword);
